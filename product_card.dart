...
class SportsProductCard extends StatelessWidget {
      ...
      children: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: product.stockQuantity > 0 ? Colors.blueAccent : Colors.grey[300],
  ...
  void _addToCart(Product product) {
    ...
    // For example, add to Firestore cart collection:
    FirebaseFirestore.instance.collection('cart_details').add({
